...
///颜色
fileprivate func kColorRGB(_ r: CGFloat, _ g: CGFloat, _ b: CGFloat) -> UIColor {
    return UIColor(red: r/255, green: g/255, blue: b/255, alpha: 1)
}
///颜色
fileprivate func kColorRGBA(_ r: CGFloat, _ g: CGFloat, _ b: CGFloat, _ a: CGFloat) -> UIColor {
    return UIColor(red: r/255, green: g/255, blue: b/255, alpha: a)
}
///黑色
fileprivate let kColorBlack: UIColor = kColorRGB(47, 47, 47)
///蓝色
fileprivate let kColorBlue = kColorRGB(46, 167, 233)
///白色
fileprivate let kColorWhite: UIColor = kColorRGB(255, 255, 255)
///灰色
fileprivate let kColorGray: UIColor = kColorRGB(170, 170, 170)
///红色
fileprivate let kColorRed: UIColor = kColorRGB(252, 23, 33)
///透明色
fileprivate let kColorClear = UIColor.clear

///本地语言文件名称
fileprivate let kLocalFileName = "Localizable"
...
///消息提示框
class ZNotificationMessageHUD: NSObject {
    /// 显示成功提示信息
    ...
    private class func addMJNotifierWithText(_ text: String, _ shouldDismiss: Bool, _ backgroundColor: UIColor, textColor: UIColor) {
        ...
        if notifierView == nil {
            ...
            if shouldDismiss == true {
                ...
                btnCancel.setTitle(NSLocalizedString("kLocalCancel", comment: kLocalFileName), for: UIControlState.normal)
